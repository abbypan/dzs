...
context [
    ...
    Purpose: "^/^-^-Various functions needed for GUI.^/^-"
...
dump-layout: func [layout /indent d] [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: gui-object.r3 4987 2013-07-12 00:23:54Z richard $}
...
^-}
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: style-make.r3 3622 2012-03-07 12:15:09Z richard $}
]
stylize: func [
...
^-}
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: style-tags.r3 4897 2013-05-31 19:22:50Z richard $}
]
style-tags: [
    internal
    layout
...
guie/style/tags: make-tags [] REBOL [
...
^-}
    ...
    Version: {$Id: style-actors.r3 4810 2013-03-21 15:09:49Z richard $}
...
guie/style/actors: make-actors none [
    ...
    Version: {$Id: style-materials.r3 4831 2013-04-02 12:27:24Z richard $}
]
...
^-}
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: face-make.r3 2474 2011-05-13 22:02:56Z cyphre $}
]
make-face: funct [
...
make-options: funct [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: face-funcs.r3 4987 2013-07-12 00:23:54Z richard $}
...
^-}
    Version: {$Id: face-nav.r3 4897 2013-05-31 19:22:50Z richard $}
...
^-}
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: face-draw.r3 4335 2012-11-01 21:31:33Z richard $}
]
...
get-panel: funct [
    ...
    Purpose: "^/^-^-Provides support face validation^/^-"
    From: "RM Asset"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id$"
]
...
do-triggers: funct [
    ...
    Purpose: "^/^-^-Adds effects to layout transitions.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
]
...
switch-layout: funct [
    ...
    Purpose: "^/^-^-Font defintions and text style creation.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id$"
]
...
face-char-size?: funct [
    ...
    Purpose: "^/^-^-Handles keyboard events for text faces.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: text-keys.r3 4897 2013-05-31 19:22:50Z richard $}
]
...
^-}
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: text-edit.r3 4987 2013-07-12 00:23:54Z richard $}
]
...
load-clip-text: does [
    ...
    Purpose: "^/^-^-Make text draw GOB blocks.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: text-draw.r3 4897 2013-05-31 19:22:50Z richard $}
]
make-text: funct [
...
^-}
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: text-caret.r3 4058 2012-08-01 00:52:40Z richard $}
]
...
move-cursor: funct [
    ...
    Purpose: "^/^-^-Support functions for events.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
]
...
init-view-system: func [
    ...
    Purpose: "^/^-^-This is the main handler for all GUI events.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: event-handler.r3 4987 2013-07-12 00:23:54Z richard $}
]
gui-events: context [
    handlers: none
    over-face:
    ...
    Purpose: "^/^-^-Standard color definitions.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
]
black: 0.0.0
...
yello: 255.240.120 REBOL [
    Title: "R3 GUI - View: popups"
    Purpose: "^/^-^-Functions for popup requestors.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
]
request: funct [
...
show-now: has [list out] [
    ...
    Title: "R3 GUI - View: show"
    Purpose: "^/^-^-The main VIEW and UNVIEW API functions.^/^-"
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: {$Id: view-window.r3 4876 2013-05-17 09:31:36Z richard $}
]
view: funct [
...
gob-handler: [
    ...
    Version: {$Id: gui-operations.r3 2649 2011-07-08 06:25:26Z Rebolek $}
]
issue-id: funct [
    "Issue unique id"
...
catenate: funct ["Joins values with delimiter."
    ...
    Version: {$Id: gui-materials.r3 4831 2013-04-02 12:27:24Z richard $}
]
...
use-color: func [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: fonts.r3 4988 2013-07-12 18:51:03Z richard $"
]
...
stylize [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: button.r3 4876 2013-05-17 09:31:36Z richard $"
]
stylize [
    clicker: [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: bars.r3 4987 2013-07-12 00:23:54Z richard $"
...
stylize [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: text.r3 4987 2013-07-12 00:23:54Z richard $"
    Todo: [
...
stylize [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: doc.r3 4935 2013-06-15 22:24:47Z bolek $"
    Todo: [
...
stylize [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: image.r3 4058 2012-08-01 00:52:40Z richard $"
]
stylize [
    sensor: [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: lists.r3 4988 2013-07-12 18:51:03Z richard $"
    Notes: []
    Known-bugs: []
    ToDo: []
]
...
set-face-key: funct [
    ...
    From: "REBOL Technologies"
    License: http://www.rebol.com/r3/rsl.html
    Version: "$Id: table.r3 2474 2011-05-13 22:02:56Z cyphre $"
]
stylize [
    table-panel: hpanel [
        options: [
